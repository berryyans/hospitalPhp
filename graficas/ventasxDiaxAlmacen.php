...
$data[] = $myrow1[0]; // agregamos el dato, suponiendo que este en la primera posici�n del arreglo resultante�
...
// aqu� ya tenemos el arreglo en $data, solo le agregamos al c�digo anterior
