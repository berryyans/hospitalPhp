...
<tr >
    ...
    <td><div align="left">
      ...
      <input name="button" type="image"  id="lanzador" value="..." src="<?php echo CONSTANT_PATH_SIMA_RAIZ;?>/imagenes/btns/fecha.png" />
    </div></td>
  </tr>
  <tr >
    <td scope="col">&nbsp;</td>
    ...
    <td><label>
      ...
      <input name="button1" type="image"  id="lanzador1" value="..." src="<?php echo CONSTANT_PATH_SIMA_RAIZ;?>/imagenes/btns/fechadate.png"/></td>
  </tr>
