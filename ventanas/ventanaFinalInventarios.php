...
##DEPRECATED NO TENGO PORQUE ACTUALIZAR EXISTENCIAS SSOLD
...
<h1 align="center" >
    <br />
TABLA DE COMPARACION Y AJUSTE A EXISTENCIAS
</font>
<br />
...
<th width="10"  align="left"><font size="1" face="Comic Sans MS,arial,verdana">#</font></th>
    ...
    <th width="10"  align="left"><font size="1" face="Comic Sans MS,arial,verdana">ExActual</font></th>
 <th width="10"  align="left"><font size="1" face="Comic Sans MS,arial,verdana">ExNueva</font></th>
      <th width="10"  align="left"><font size="1" face="Comic Sans MS,arial,verdana">Diff</font></th>
...
<?php 
	  $t= (int) ($myrow8ac1e['entrada']-$myrow1['existencia']);
	  
          if($t<0){
               echo '<strong style="color: red;">'.$t.'</strong>';
          }else{
              echo $t;
          }
		?>
...
<p align="center">&nbsp;</p>
  ...
  <p align="center">
    ...
    <?php if($a>0){?>
    <blink><input  name="vaciar" type="submit" value="Vaciar Almacen" style="color: red"	onclick="return confirmReset();"/></blink>
    <br>
        <br>
 <font size="1" face="Comic Sans MS,arial,verdana">
<input  name="ajustarExistencias" type="submit" value="Ajuste Definitivo de Existencias"	/>
