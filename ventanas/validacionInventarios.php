...
$entrance=$entrance->entradaListaInventarios($costo[$j],$numSolicitud,$codigoInv,"si",$_POST['almacenDestino1'],$fecha1,$hora1,$_GET['id_factura'],$usuario,$entidad,$basedatos);
//******************************************
