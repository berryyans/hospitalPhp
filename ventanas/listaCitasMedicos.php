...
<!-Hoja de estilos del calendario --> 
  <link rel="stylesheet" type="text/css" media="all" href="<?php echo CONSTANT_PATH_SIMA_RAIZ;?>/calendario/calendar-blue.css" title="win2k-cold-1" /> 
...
<form id="form2" name="form2" method="post" >
  <p align="center"><span class="Estilo25">Escoje la Fecha
    ...
    <input name="button" type="image" src="<?php echo CONSTANT_PATH_SIMA_RAIZ;?>/imagenes/calendario.png" id="lanzador" value="..." />
