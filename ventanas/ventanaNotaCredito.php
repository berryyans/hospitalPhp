...
require(CONSTANT_PATH_CONFIGURACION."/ventanasEmergentes.php"); require(CONSTANT_PATH_CONFIGURACION.'/funciones.php');require(CONSTANT_PATH_CONFIGURACION."/clases/generaFolioVenta.php");?>
...
<script>
		new Autocomplete("paciente", function() {
			...
			return "<?php echo CONSTANT_PATH_SIMA_RAIZ;?>/cargos/foliosVentax.php?entidad=<?php echo $entidad;?>&q=" + this.value;
