...
require(CONSTANT_PATH_CONFIGURACION."/funciones.php"); $ALMACEN=$_GET['datawarehouse'];?>
<?PHP require(CONSTANT_PATH_CONFIGURACION."/clases/valida.php");?>
<?PHP require(CONSTANT_PATH_CONFIGURACION."/baseDatos.php"); 
$base=new MYSQL();
...
<table width="698" align="center">
    ...
    <tr bgcolor="#99CCFF">
      <td colspan="2" ><strong>Cuarto:</strong> <?php echo $_GET['descripcionCuarto']; ?></td>
...
$myrow6 = mysql_fetch_array($result6);
    ...
    <tr>
      <td colspan="3" >Correco electr&oacute;nico</td>
    </tr>
    <tr>
...
<table width="737"  align="center"  >
  ...
  <tr >
    <td colspan="3" bgcolor="#99CCFF" class="normalmid">Tel&eacute;fono fijo y celular:</td>
  </tr>
  <tr >
