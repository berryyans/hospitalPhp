  ...
  <table width="595" class="table-template">
    ...
    <tr>
      <td height="33" colspan="3" ><label>
        ...
        <input name="consultas2" type="submit"  id="consultas2"  onclick="javascript:ventanaSecundaria2('<?php echo CONSTANT_PATH_SIMA_RAIZ;?>/ADMINHOSPITALARIAS/inventarios/barcode/index.php?numeroE=<?php echo $myrow['numeroE']; ?>
