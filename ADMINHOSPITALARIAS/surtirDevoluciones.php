...
<body>
 ...
 <form id="form1" name="form1" method="post" >
  <h1 align="center">SURTIR DEVOLUCIONES</h1>
   ...
   <table width="700" class="table-template">
    <tr >
      <th width="17" >Hora</th>
...
<?php if($myrow['statusCargo']!='cargado'){         ?>
          <a href="#"  onclick="javascript:ventanaSecundaria('<?php echo CONSTANT_PATH_SIMA_RAIZ;?>/cargos/despliegaSolicitudesDirectas.php?departamentoSolicitante=<?php echo $myrow['descripcionAlmacen'];?>&numeroE=<?php echo $myrow['numeroE']; ?>
