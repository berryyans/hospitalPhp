...
?>
        ...
        <a href="javascript:ventanaSecundaria('sesionFuera.php?codigo=<?php echo $code; ?>&amp;seguro=<?php echo $_POST['seguro']; ?>&amp;medico=<?php echo $_POST['medico']; ?>&amp;usuario=<?php echo $E; ?>')"> <img src="sinCandado.png" width="23" height="23" border="0" onClick="if(confirm('Esta seguro que deseas cerrarle la sesi�n?') == false){return false;}" /></a>
        <?php }else { ?>
