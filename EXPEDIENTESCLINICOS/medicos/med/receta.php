...
?>
  ...
  <form id="form1" name="form1" method="GET" action="" onSubmit="return valida(this);" >
    ...
    <table width="591" border="0" align="center" class="style7">
      ...
      <tr>
        <td height="33">&nbsp;</td>
        <td><input name="actualizar" type="submit" class="style7" id="actualizar" value="Agregar Indicaciones" onClick="if(confirm('Esta seguro que deseas aplicar este diagn�stico?') == false){return false;}" />
