...
<textarea name="medicamentos" cols="80" rows="10" wrap="virtual" id="medicamentos"><?php echo $myrow25['medicamentos'];?></textarea>
      ...
      <tr>
        <td height="33">&nbsp;</td>
        <td><input name="actualizar" type="submit" class="style7" id="actualizar" value="Guardar Medicamentos" onClick="if(confirm('Esta seguro que deseas aplicar este diagn�stico?') == false){return false;}" />
