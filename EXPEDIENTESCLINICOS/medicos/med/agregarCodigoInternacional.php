    ...
    <table width="532" border="1" align="center" class="style7">
      ...
      <tr>
        ...
        <td><span class="style12">
          <input name="actualizar" type="submit" class="style7" id="actualizar" value="Aplicar Codigo Internacional" onClick="if(confirm('Esta seguro que deseas aplicar este diagn&oacute;stico?') == false){return false;}" onMouseOver="Tip('<div class=&quot;estilo25&quot;><?php echo 'Aplicar C�digo Internacionales';?></div>')" onMouseOut="UnTip()"  />
        </span>
