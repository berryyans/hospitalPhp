...
echo 'Almac�n o mini-Almac�n agregado..'; 
}} else {
   ...
   <table width="709" border="0" align="center">
     ...
     <tr>
       ...
       <td width="568" class="style12"><label>
         <textarea name="problema" cols="80" wrap="virtual" class="style12" id="problema">Secundigesta de + ces�rea previa + DCP</textarea>
       </label></td>
     </tr>
     <tr>
     ...
     <tr>
       ...
       <td class="style12"><textarea name="subjetivo" cols="80" wrap="virtual" class="Estilo24" id="subjetivo">Embarazo de SDG en prodr�modos de trabajo de Parto. Se programa para ces�rea por ces�rea previa.</textarea></td>
     </tr>
