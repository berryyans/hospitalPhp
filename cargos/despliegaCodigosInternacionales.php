...
<form id="form1" name="form1" method="post" action="#" >
    <table width="545" align="center" cellpadding="0" cellspacing="0" class="style71" style="border: 1px solid #000000;">
      ...
      <tr valign="middle" bgcolor="#FFCCFF" class="catalogo">
		...
		value="<?php echo $_GET['nombres'];?>" onmouseover="Tip('<div class=&quot;estilo25&quot;><?php echo 'Escribe el posible diagn�stico..';?></div>')" onMouseOut="UnTip()" />
          <input name="mostrar" type="submit" class="style71" id="mostrar2" value="&gt;" onmouseover="Tip('<div class=&quot;estilo25&quot;><?php echo 'Presiona �ste bot�n para mostrar los posibles resultados de acuerdo a tu b�squeda';?></div>')" onMouseOut="UnTip()" />
          </label>
&nbsp;
...
?>
        ...
        <td height="23" bgcolor="<?php echo $color;?>" class="Estilo24"><span class="style7">
          ...
          <div align="left"><a 
		  onmouseover="Tip('<div class=&quot;estilo25&quot;><?php echo 'Muestra el c�digo internacional: '.$myrow['descripcion'].' basada en DC9';?></div>')" onMouseOut="UnTip()"
