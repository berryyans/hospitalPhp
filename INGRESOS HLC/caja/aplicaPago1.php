...
include(CONSTANT_PATH_CONFIGURACION."/ingresoshlcmenu/menuingresoshlc.php"); valida('CAJA','LOPI',$usuario,$basedatos);?>
...
if($poliza=$myrowC['numeroPoliza']){ //*******************Comienzo la validaci�n*****************
//********************Llenado de datos
