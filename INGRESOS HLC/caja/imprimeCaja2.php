...
if($um=='s' or $um=='S')$myrow3['descripcion']='[Honorarios M�dicos por Interpretaci�n de Resultados] '.$myrow3['descripcion'];
...
$pdf->SetXY(22,$Y+13);
$pdf->Cell(0,0,'(Este no es un documento fiscal v�lido)',0,0,L);
