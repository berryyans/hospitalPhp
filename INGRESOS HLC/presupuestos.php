...
?>
    ...
    <body>
        ...
        <br>
            <h1 align="center" >Hacer Presupuesto<?php echo $leyenda; ?></h1>
...
<?php while ($resCombo = mysql_fetch_array($rCombo)) { ?>
                                    ...
                                    ?>
                                        value="<?php echo $resCombo['almacen']; ?>"><?php echo $resCombo['descripcion']; ?>
                                    </option>
                                <?php } ?>
                                </select>
                            </p>  
                    ...
                    <tr valign="middle" >
                        <td height="49" colspan="3" >
                            <div align="center">
                                <input name="numeroEx" type="hidden"  id="numeroEx" value="<?php if ($_POST['numeroEx'] and !$_POST['nuevo']) {
                                    echo $_POST['numeroEx'];
                                } ?>" readonly="" />
                            </div>
                        </td>
                            ...
                            <div align="center">
                                <span >
                                    <input name="seguro" type="hidden"  id="seguro"   readonly=""
                                           value="<?php if ($_POST['seguro'] and !$_POST['nuevo']) {
                                    echo $_POST['seguro'];
                                } else {
                                    echo "0";
                                } ?>" 
                ...
                <table width="762" class="table-template-left">
                    <tr>
                        <th colspan="12" align="center" >
                            <p align="center">Paciente <span ><?php echo $paciente; ?></span></p>
                        </th>
                    </tr>
                    ...
                    <tr>
                        <?php if ($seguro != NULL) { ?>
                            <td colspan="4"  >Seguro<span >:  
                                ...
                                <?php } else { ?>
                            <td colspan="4"  >Cliente Particular<span ></span>
                            </td>
                                <?php } ?>
