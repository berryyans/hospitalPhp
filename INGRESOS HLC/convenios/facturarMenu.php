...
<div align="center">
  ...
  <table width="200" border="0" cellspacing="0">
    <tr>
      <td>&nbsp;</td>
      <td><input onmouseover="Tip('<div class=&quot;estilo25&quot;><?php echo 'Presiona aqu� para hacer notas de cargo..';?></div>')" onmouseout="UnTip()" name="nuevo" type="image"  id="nuevo" value="Cargos a Pacientes" src="<?php echo CONSTANT_PATH_SIMA_RAIZ;?>/imagenes/btns/new_cargos.png"
    ...
    <tr>
      <td>&nbsp;</td>
      <td><input onmouseover="Tip('<blink><div class=&quot;estilo25&quot;><?php echo 'Este bot�n es para agregar cargos a pacientes que tienen un paquete..';?></div></blink>')" onmouseout="UnTip()" name="nuevo2" type="image"  id="nuevo2" src="<?php echo CONSTANT_PATH_SIMA_RAIZ;?>/imagenes/btns/new_paq.png" value="Pacientes por Paquetes"
    ...
    <tr>
      <td>&nbsp;</td>
      <td><input onmouseover="Tip('<div class=&quot;estilo25&quot;><?php echo 'Presiona aqu� para ver los servicios recibidos..';?></div>')" onmouseout="UnTip()" name="nuevo22" type="image" src="<?php echo CONSTANT_PATH_SIMA_RAIZ;?>/imagenes/btns/new_service.png" id="nuevo22" value="Listado de Pacientes"
