...
echo mysql_error();
if($resulScripModulo['usuario']){ ?>
stm_aix("p3i6","p2i2",[0," Convenios x Grupo de Productos","","",-1,-1,0,"<?php echo CONSTANT_PATH_SIMA_RAIZ;?>/INGRESOS%20HLC/convenios/convenioxGP.php","_self","","","","",5,0,0,"","",0,0,0,0,1,"#FFD2FC",0,"#7a8c9e",1,"","fade.gif",3,3,0,0,"#7A8C9E","#CCCC00","#333333","#FFF480","7pt Verdana","7pt Verdana"],178,22);
<?php } ?>
...
echo mysql_error();
if($resulScripModulo['usuario']){ ?>
stm_aix("p3i6","p2i2",[0," Convenios x Articulos/Proc.","","",-1,-1,0,"<?php echo CONSTANT_PATH_SIMA_RAIZ;?>/INGRESOS%20HLC/convenios/convenioxArticulos.php","_self","","","","",5,0,0,"","",0,0,0,0,1,"#FFD2FC",0,"#7a8c9e",1,"","fade.gif",3,3,0,0,"#7A8C9E","#CCCC00","#333333","#FFF480","7pt Verdana","7pt Verdana"],178,22);
<?php } ?>
...
echo mysql_error();
if($resulScripModulo['usuario']){?>
stm_aix("p0i9","p0i6",[0,"CAJA","","",-1,-1,0,"<?php echo CONSTANT_PATH_SIMA_RAIZ;?>/INGRESOS%20HLC/caja/","_self","","","icon_10a.gif","icon_10b.gif",7,13,0,"0604arroldw.gif","0604arroldw.gif",9,7,0,1,1,"#730270",0,"#730270",0,"","",0,0,0,0,"#009999","#50647f","#FFF480","#FFFF00","bold 8pt Arial","8pt Arial",0,0],52,30);
...
echo mysql_error();
if($resulScripModulo['usuario']){?>
stm_aix("p0i9","p0i6",[0," CXC","","",-1,-1,0,"<?php echo CONSTANT_PATH_SIMA_RAIZ;?>/INGRESOS%20HLC/cxc/","_self","","","icon_10a.gif","icon_10b.gif",7,13,0,"0604arroldw.gif","0604arroldw.gif",9,7,0,1,1,"#730270",0,"#730270",0,"","",0,0,0,0,"#009999","#50647f","#FFF480","#FFFF00","bold 8pt Arial","8pt Arial",0,0],52,30);
stm_bpx("p9","p1",[1,4,0,3,0,4,5,0,100,"",-2,"",-2,48,2,3,"#999999","transparent","",0,0,0,"#333333"]);
stm_aix("p9i0","p1i0",[6,1,"#50647f","",-1,-1,0]);
...
stm_aix("p10i1","p6i0",[0," Men� principal","","",-1,-1,0,"<?php echo CONSTANT_PATH_SIMA_RAIZ;?>/MenuIndex.php","_self","","","","",5,0,0,"","",0,0,0,0,1,"#FFD2FC",0,"#CCCCCC",1,"","fade.gif",3,3,0,0,"#7A8C9E","#CCCC00","#333333","#FFF480","7pt Verdana","7pt Verdana"],90,22);
