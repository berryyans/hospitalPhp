...
<td width="32" bgcolor="<?php echo $color?>" ><div align="center"><a href="javascript:ventanaSecundaria1('../ventanas/lentesopticaPrint.php?folioVenta=<?php echo $myrow['folioVenta']; ?>&amp;keyClientesInternos=<?php echo $myrow['keyClientesInternos']; ?>&amp;usuario=<?php echo $usuario; ?>&amp;paciente=<?php echo $myrow['paciente'];?>')"><img src="<?php echo CONSTANT_PATH_SIMA_RAIZ;?>/imagenes/btns/printer.png" alt="" width="20" height="20" border="0" /></a>
