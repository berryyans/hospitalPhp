...
<br />
 <div align="left">
		...
		value="<?php
         ...
         <input name="button2" type="image"src="<?php echo CONSTANT_PATH_SIMA_RAIZ;?>/imagenes/btns/fecha.png" id="lanzador1" value="..." />
		...
		value="<?php
         ...
         <input name="button" type="image"src="<?php echo CONSTANT_PATH_SIMA_RAIZ;?>/imagenes/btns/fecha.png" id="lanzador" value="..." />
