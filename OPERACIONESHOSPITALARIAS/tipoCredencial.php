...
function valida(F) {   
        ...
        if( vacio(F.keyTCred.value) == false ) {   
                ...
                alert("Por Favor, escribe la descripci�n de este keyTCred!")   
                return false   
...
echo mysql_error();
echo 'La transacci�n deber� ser removida manualmente!';
echo '<script >
