...
<form id="form1" name="form1" method="post" action="">
    ...
    <p align="center">
	  ...
	  onclick="nueva('<?php echo CONSTANT_PATH_SIMA_RAIZ;?>/cargos/listadoVentasPacientes.php?paquetes=paquetes&amp;almacen=<?php echo $ALMACEN;?>','ventanaSecundaria10','500','500','yes')" value="VER NCs" />
      <label></label>
    </p>
</form>
<h1 align="center">&nbsp;</h1>
