...
<div align="center">
  ...
  <?php //echo $ALMACEN;?>
  &nbsp;</p>
  <p><img src="<?php echo CONSTANT_PATH_SIMA_RAIZ;?>/imagenes/imagenesModulos/<?php echo $imagen;?>" width="655" height="309"></p>
  <p>
  ...
  <table width="37%" border="0" cellspacing="0" cellpadding="0">
    <tr valign="middle">
      <td width="34%"><div align="center">
        <input onMouseOver="Tip('<div class=&quot;estilo25&quot;><?php echo 'Presiona aqu� para generar una Orden de Compras..';?></div>')" onMouseOut="UnTip()" name="nuevo" 
		type="image"   id="nuevo" value="....." src="<?php echo CONSTANT_PATH_SIMA_RAIZ;?>/imagenes/btns/genorden.png"
      ...
      <td width="30%"><div align="center">
        <input onMouseOver="Tip('<div class=&quot;estilo25&quot;><?php echo 'Presiona aqu� para ver la Listas Generadas';?></div>')" onMouseOut="UnTip()" name="nuevo22" type="image" src="<?php echo CONSTANT_PATH_SIMA_RAIZ;?>/imagenes/btns/lisorden.png" id="nuevo22" value="List&acirc;o de Ordem"
