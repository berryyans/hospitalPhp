...
echo mysql_error();
      ...
      <td bgcolor="<?php echo $color;?>" class="style71" ><div align="left"><span class=""> <a href="javascript:ventanaSecundaria2('<?php echo CONSTANT_PATH_SIMA_RAIZ;?>/cargos/listaAlmacenes.php?codigo=<?php echo $code; ?>&seguro=<?php echo $_GET['seguro']; ?>&medico=<?php echo $_GET['medico']; ?>&usuario=<?php echo $usuario; ?>')"> <img src="<?php echo CONSTANT_PATH_SIMA_RAIZ;?>/imagenes/almacen.jpeg" alt="Almacenes" width="12" height="12" border="0" /></a> </span></div></td>
...
?>
<a href="javascript:ventanaSecundaria19('<?php echo CONSTANT_PATH_SIMA_RAIZ;?>/cargos/imprimirPrecios.php?nRequisicion=<?php echo $requisicion; ?>&amp;almacen=
		<?php echo $_POST['almacenDestino1']; ?>&amp;gpoProducto=<?php echo $gpoProducto; ?>&amp;codigo=<?php echo $C; ?>&amp;almacenes=<?php echo $Cd; ?>')"><img src="<?php echo CONSTANT_PATH_SIMA_RAIZ;?>/imagenes/impresora.jpg" alt="Modificar Precios" width="117" height="60" border="0" /></a></div>
</body>
</html>
