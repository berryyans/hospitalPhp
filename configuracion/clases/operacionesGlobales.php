...
$cargo[0]+=sprintf("%01.2f",($myrow['precioVenta']*$myrow['cantidad'])+($myrow['iva']*$myrow['cantidad']));
}

//ABONOS
if($myrow['naturaleza']=='A' and $myrow['gpoProducto']==''){ 
$abono[0]+=sprintf("%01.2f",($myrow['precioVenta']*$myrow['cantidad'])+($myrow['iva']*$myrow['cantidad']));
}


//DEVOLUCIONES
if($myrow['naturaleza']=='A' and $myrow['statusDevolucion']=='si'){
$devolucion[0]+=sprintf("%01.2f",($myrow['precioVenta']*$myrow['cantidad'])+($myrow['iva']*$myrow['cantidad']));
}


//DEVOLUCIONES CARGOS
if($myrow['naturaleza']=='C' and $myrow['statusDevolucion']=='si'){
$devolucionCargos[0]+=sprintf("%01.2f",($myrow['precioVenta']*$myrow['cantidad'])+($myrow['iva']*$myrow['cantidad']));
}
...
//REGRESOS
if($myrow['naturaleza']=='C' and $myrow['statusRegreso']=='si'){ 
$regreso[0]+=sprintf("%01.2f",($myrow['precioVenta']*$myrow['cantidad'])+($myrow['iva']*$myrow['cantidad']));
}
//*******************************************************************************
...
//CARGOS PARTICULARES 
if($myrow['naturaleza']=='C'  and $myrow['statusRegreso']!='si'){ 
$cargoParticular[0]+=sprintf("%01.2f",($myrow['cantidadParticular']*$myrow['cantidad'])+($myrow['ivaParticular']*$myrow['cantidad']));
}

//ABONOS
if($myrow['naturaleza']=='A' and $myrow['gpoProducto']==''){
$abonoParticular[0]+=sprintf("%01.2f",($myrow['cantidadParticular']*$myrow['cantidad'])+($myrow['ivaParticular']*$myrow['cantidad']));
}


//DEVOLUCIONES
if($myrow['naturaleza']=='A' and $myrow['statusDevolucion']=='si'){
$devolucionParticular[0]+=sprintf("%01.2f",($myrow['cantidadParticular']*$myrow['cantidad'])+($myrow['ivaParticular']*$myrow['cantidad']));
}

//REGRESO DE EFECTIVO
if($myrow['naturaleza']=='C' and $myrow['statusRegreso']=='si'){ 
$regresoParticular[0]+=sprintf("%01.2f",($myrow['cantidadParticular']*$myrow['cantidad'])+($myrow['ivaParticular']*$myrow['cantidad']));
}
//******************************************************************************************
...
if($myrow['naturaleza']=='C' and $myrow['gpoProducto']!=''){//cargos al paciente
   $cargosBeneficencia[0]+=sprintf("%01.2f",($myrow['cantidadBeneficencia']*$myrow['cantidad'])+($myrow['ivaBeneficencia']*$myrow['cantidad']));
}

if($myrow['naturaleza']=='A' and $myrow['gpoProducto']!=''){//devolucion de cargo beneficencia
$devolucionBeneficencia[0]+=sprintf("%01.2f",($myrow['cantidadBeneficencia']*$myrow['cantidad'])+($myrow['ivaBeneficencia']*$myrow['cantidad']));
}

if($myrow['tipoTransaccion']=='DEVXB'){ 
$dtBeneficencia[0]+=sprintf("%01.2f",($myrow['precioVenta']*$myrow['cantidad'])+($myrow['iva']*$myrow['cantidad']));
}
...
if($myrow['naturaleza']=='C'  and $myrow['statusRegreso']!='si'){
$cargoAseguradora[0]+=sprintf("%01.2f",($myrow['cantidadAseguradora']*$myrow['cantidad'])+($myrow['ivaAseguradora']*$myrow['cantidad']));
}

//ABONOS
if($myrow['naturaleza']=='A' and $myrow['gpoProducto']==''){
$abonoAseguradora[0]+=sprintf("%01.2f",($myrow['cantidadAseguradora']*$myrow['cantidad'])+($myrow['ivaAseguradora']*$myrow['cantidad']));
}


//DEVOLUCIONES
if($myrow['naturaleza']=='A' and $myrow['statusDevolucion']=='si'){ 
$devolucionAseguradora[0]+=sprintf("%01.2f",($myrow['cantidadAseguradora']*$myrow['cantidad'])+($myrow['ivaAseguradora']*$myrow['cantidad']));
}

//REGRESO DE TRASLADO
if($myrow['naturaleza']=='C' and $myrow['statusRegreso']=='si'){
$regresoAseguradora[0]+=sprintf("%01.2f",($myrow['cantidadAseguradora']*$myrow['cantidad'])+($myrow['ivaAseguradora']*$myrow['cantidad']));
}
