...
echo 'msgbox "SE AGREG� EL DIAGNOSTICO "'.$myrow5['descripcion']; 
echo '</script>';
}
?>
   <script language="JavaScript" type="text/javascript">
  ...
  <form id="form1" name="form1" method="post" action="" onSubmit="return valida(this);" >
    ...
    <table width="522" border="1" align="center" class="style7">
      ...
      <tr>
        ...
        <td><input name="actualizar" type="submit" class="style7" id="actualizar" value="Aplicar Dx" onClick="if(confirm('Esta seguro que deseas aplicar este diagn�stico?') == false){return false;}" />
