...
<form id="form1" name="form1" method="post" action="#">
  ...
  <table width="420" >
  <!--<table width="420" class="table-template-left">-->
    <tr>
  ...
  <table width="900"  class="table-template-left">
...
<script>
		new Autocomplete("paciente", function() { 
			...
			return "<?php echo CONSTANT_PATH_SIMA_RAIZ;?>/cargos/clientesInternosx.php?basedatos=<?php echo $basedatos;?>&entidad=<?php echo $entidad;?>&q=" + this.value;
