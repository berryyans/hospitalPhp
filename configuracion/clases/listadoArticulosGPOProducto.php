...
} //cierra validacion de art�culos
}
...
echo mysql_error();
	  ?>
        <select name="gpoProducto[]" class="combos" id="gpoProducto[]" onmouseover="Tip('<div class=&quot;estilo25&quot;><?php echo 'Escoje el Grupo de Producto para Art�culo: '.$myrow['descripcion'];?></div>')" onmouseout="UnTip()">
