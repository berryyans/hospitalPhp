...
document.Form2.criterio.focus();
  ...
  <table width="537" class="table table-striped">
    ...
    <tr >
      ...
      <th width="100" >Codigo Barra </th>
      <th width="106" >Grupo</th>
      <th width="106" >Unidades</th>
      <th width="106" >Conf</th>
...
?></td>
      <td >
        <input name="keyPA[]" type="hidden" id="codigo" value="<?php echo $myrow['keyPA'];?>" />
          ...
          <label>
          <textarea name="descripcion[]"  cols="30" rows="1" wrap="physical"  ><?php
      ...
      value="<?php if($myrow['cbarra']){ echo ltrim($myrow['cbarra']);} ?>" size="12" /></td>
...
echo mysql_error();
	  ?>
		...
		?>
          ...
          <td  align="center">
          <?php if($myrow['cajaCon']>0){ echo $myrow['cajaCon'];}else{echo '---';} ?>
          </td>
        
        
      <td>
      <a  href="javascript:ventanaSecundaria2('../ventanas/ventanaCatalogoConfArticulos.php?main=<?php echo $_GET['main'];?>&warehouse=<?php echo $_GET['warehouse'];?>&codigo=<?php echo $code; ?>&amp;seguro=<?php echo $_GET['seguro']; ?>&amp;medico=<?php echo $_GET['medico']; ?>&amp;usuario=<?php echo $usuario; ?>&configuracion=<?php echo $myrow['configuracion']; ?>&amp;keyPA=<?php echo $myrow['keyPA']; ?>&amp;gpoProducto=<?php echo $myrow['gpoProducto'];?>&descripcion=<?php echo $myrow['descripcion'];?>')" onMouseover="showhint('Presiona aqui para asignar almacenes a este articulo...', this, event, '150px')">
              <img src="../images/s_process.png" alt="Almacenes" width="20" height="20" border="0" />
          </a>
      </td>
