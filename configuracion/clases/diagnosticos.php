...
function valida(F) {   
        ...
        if( vacio(F.despliega.value) == false ) {   
                alert("Por Favor, escribe el C�digo Internacional!")   
                return false   
        }         
}   
</script> 
...
echo '<blink>'.'Ya existe �ste C�digo Internacional'.'</blink>';
}
...
?>
          ...
          <a 
		   onmouseover="Tip('&lt;div class=&quot;estilo25&quot;&gt;<?php echo 'Agregar c�digos Internacionales';?>&lt;/div&gt;')" onMouseOut="UnTip()"
...
C&oacute;digo Internacional <a 
					onmouseover="Tip('&lt;div class=&quot;estilo25&quot;&gt;<?php echo 'Editar c�digo internacional';?>&lt;/div&gt;')" onMouseOut="UnTip()"
...
?>
          ...
          <a 
		   onmouseover="Tip('<div class=&quot;estilo25&quot;><?php echo 'Agregar el cuadro cl�nico';?></div>')" onMouseOut="UnTip()"
          ...
          Cuadro Cl&iacute;nico Agregado 
		            ...
		            <a 
					onmouseover="Tip('<div class=&quot;estilo25&quot;><?php echo 'Editar cuadro cl�nico';?></div>')" onMouseOut="UnTip()"
