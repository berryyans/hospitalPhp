...
<tr>
  ...
  <table width="550" class="table-template-left">
 ...
 <td ><label></label></td>
    ...
    <tr >
      ...
      <td colspan="2" valign="middle" >
          <a href="javascript:ventanaSecundaria3('<?php echo CONSTANT_PATH_SIMA_RAIZ;?>/cargos/cBarraSubeVentana.php?codigo=<?php echo $_POST['codigo']; ?>&amp;seguro=<?php echo $_POST['seguro']; ?>&amp;medico=<?php echo $_POST['medico']; ?>&amp;usuario=<?php echo $usuario; ?>')"><img src="<?php echo CONSTANT_PATH_SIMA_RAIZ;?>/imagenes/barcode.gif" width="89" height="68" border="0" /></a>(Click en la imagen para generar el Codigo de Barra)</td>
    </tr>
