...
echo mysql_error();
if($resulScripModulo['usuario']){ ?>
stm_aix("p7i18","p2i2",[0," �rdenes Compra","","",-1,-1,0,"listadoOrdenes.php","_self","","","","",5,0,0,"","",0,0,0,0,1,"#FFD2FC",0,"#7a8c9e",1,"","/sima/imagenes/fade.gif",3,3,0,0,"#7A8C9E","#CCCC00","#333333","#FFF480","7pt Verdana","7pt Verdana"],138,22);
<?php } ?>
...
echo mysql_error();
if($resulScripModulo['usuario']){ ?>
stm_aix("p7i18","p2i2",[0," Hoja de Auditor�a","","",-1,-1,0,"ingresosISR.php","_self","","","","",5,0,0,"","",0,0,0,0,1,"#FFD2FC",0,"#7a8c9e",1,"","/sima/imagenes/fade.gif",3,3,0,0,"#7A8C9E","#CCCC00","#333333","#FFF480","7pt Verdana","7pt Verdana"],138,22);
<?php } ?>
