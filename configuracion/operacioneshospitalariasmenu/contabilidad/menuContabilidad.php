...
echo mysql_error();
if($resulScripModulo['usuario']){ ?>
stm_aix("p7i18","p2i2",[0," �rdenes Compra","","",-1,-1,0,"listadoOrdenes.php","_self","","","","",5,0,0,"","",0,0,0,0,1,"#FFD2FC",0,"#7a8c9e",1,"","<?php echo CONSTANT_PATH_SIMA_RAIZ;?>/imagenes/fade.gif",3,3,0,0,"#7A8C9E","#CCCC00","#333333","#FFF480","7pt Verdana","7pt Verdana"],138,22);
<?php } ?>
...
echo mysql_error();
if($resulScripModulo['usuario']){ ?>
stm_aix("p0i9","p0i6",[0,"REPORTES","","",-1,-1,0,"","_self","","","<?php echo CONSTANT_PATH_SIMA_RAIZ;?>/imagenes/icon_10a.gif","<?php echo CONSTANT_PATH_SIMA_RAIZ;?>/imagenes/icon_10b.gif",7,13,0,"<?php echo CONSTANT_PATH_SIMA_RAIZ;?>/imagenes/0604arroldw.gif","<?php echo CONSTANT_PATH_SIMA_RAIZ;?>/imagenes/0604arroldw.gif",9,7,0,1,1,"#730270",0,"#730270",0,"","",0,0,0,0,"#009999","#50647f","#FFF480","#FFFF00","bold 8pt Arial","8pt Arial",0,0],52,30);
stm_bpx("p9","p1",[1,4,0,3,0,4,5,0,100,"",-2,"",-2,48,2,3,"#999999","transparent","",0,0,0,"#333333"]);
stm_aix("p9i0","p1i0",[6,1,"#50647f","",-1,-1,0]);
...
echo mysql_error();
if($resulScripModulo['usuario']){ ?>
stm_aix("p7i10","p2i2",[0," Ejecutar Sumatoria","","",-1,-1,0,"calculopago.php","_self","","","","",5,0,0,"","",0,0,0,0,1,"#FFD2FC",0,"#7a8c9e",1,"","<?php echo CONSTANT_PATH_SIMA_RAIZ;?>/imagenes/fade.gif",3,3,0,0,"#7A8C9E","#CCCC00","#333333","#FFF480","7pt Verdana","7pt Verdana"],138,22);
<?php } ?>
...
echo mysql_error();
if($resulScripModulo['usuario']){ ?>
stm_aix("p7i10","p2i2",[0," Ventas x Depto.","","",-1,-1,0,"ventasxAlmacen.php","_self","","","","",5,0,0,"","",0,0,0,0,1,"#FFD2FC",0,"#7a8c9e",1,"","<?php echo CONSTANT_PATH_SIMA_RAIZ;?>/imagenes/fade.gif",3,3,0,0,"#7A8C9E","#CCCC00","#333333","#FFF480","7pt Verdana","7pt Verdana"],138,22);
<?php } ?>
...
echo mysql_error();
if($resulScripModulo['usuario']){ ?>
stm_aix("p7i18","p2i2",[0," Auditar IVA x Pagar","","",-1,-1,0,"ivaxPagar.php","_self","","","","",5,0,0,"","",0,0,0,0,1,"#FFD2FC",0,"#7a8c9e",1,"","<?php echo CONSTANT_PATH_SIMA_RAIZ;?>/imagenes/fade.gif",3,3,0,0,"#7A8C9E","#CCCC00","#333333","#FFF480","7pt Verdana","7pt Verdana"],138,22);
<?php } ?>
...
echo mysql_error();
if($resulScripModulo['usuario']){ ?>
stm_aix("p7i18","p2i2",[0," Hoja de Auditor�a","","",-1,-1,0,"ingresosISR.php","_self","","","","",5,0,0,"","",0,0,0,0,1,"#FFD2FC",0,"#7a8c9e",1,"","<?php echo CONSTANT_PATH_SIMA_RAIZ;?>/imagenes/fade.gif",3,3,0,0,"#7A8C9E","#CCCC00","#333333","#FFF480","7pt Verdana","7pt Verdana"],138,22);
<?php } ?>
