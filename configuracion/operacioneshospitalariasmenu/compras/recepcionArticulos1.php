...
//$leyenda="La cantidad que est�s intentando actualizar es mayor a la cantidad requerida";
}
}
...
//echo "Cantidad a 0";
	...
	?> onClick="if(confirm('Esta seguro de enviar al cendis estos art�culos? La operaci�n es irreversible...') == false){return false;}"></th>
