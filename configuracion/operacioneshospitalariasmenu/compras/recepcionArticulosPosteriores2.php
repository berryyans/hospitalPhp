...
//$leyenda="Se agregaron art�culos posteriores";
}
...
//echo "Cantidad a 0";
	...
	?> onClick="if(confirm('Esta seguro de enviar al cendis estos art�culos? La operaci�n es irreversible...') == false){return false;}" disabled="disabled"></th>
...
$myrow12 = mysql_fetch_array($result12); 
	 ...
	 echo 'disabled="disabled"';
		...
		onClick="if(confirm('Deseas continuar? La operaci�n es irreversible...') == false){return false;}"/>
      </label></th>
    </tr>
  </table>
  <p align="center"><label></label>
