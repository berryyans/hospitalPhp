...
echo mysql_error();
      ...
      <td bgcolor="<?php echo $color;?>" class="style71" ><div align="center"><span class=""> <a  href="javascript:ventanaSecundaria2('<?php echo CONSTANT_PATH_SIMA_RAIZ;?>/cargos/listaAlmacenes.php?codigo=<?php echo $code; ?>&seguro=<?php echo $_GET['seguro']; ?>&medico=<?php echo $_GET['medico']; ?>&usuario=<?php echo $usuario; ?>&keyPA=<?php echo $myrow['keyPA']; ?>')"> 
      <img src="<?php echo CONSTANT_PATH_SIMA_RAIZ;?>/imagenes/btns/precio.png" alt="Almacenes" width="20" height="20" border="0" /></a> </span></div></td>
    </tr>
    <?php }?>
  </table>
  <p align="center">
