...
echo mysql_error();
if($resulScripModulo['usuario']){ ?>
stm_aix("p8i1","p1i4",[0," Cat�logo de Materiales","","",-1,-1,0,"/sima/OPERACIONESHOSPITALARIAS/laboratorio/materiales.php","_self","","","","",5,0,0,"","",0,0,0,0,1,"#FFD2FC",0,"#CCCCCC",1,"","/sima/imagenes/fade.gif",3,3,0,0,"#7A8C9E","#CCCC00","#333333","#FFF480","7pt Verdana","7pt Verdana"],160,22);
<?php } ?>
...
echo mysql_error();
if($resulScripModulo['usuario']){ ?>
stm_aix("p2i1","p1i2",[0," Venta P�blico","","",-1,-1,0,"/sima/OPERACIONESHOSPITALARIAS/laboratorio/cargosAmbulatorios.php","_self","","","","",5,0,0,"","",0,0,0,0,1,"#FFD2FC",0,"#CCCCCC",1,"","/sima/imagenes/fade.gif",3,3,0,0,"#7A8C9E","#CCCC00","#333333","#FFF480","7pt Verdana","7pt Verdana"],160,22);
<?php } ?>
...
echo mysql_error();
if($resulScripModulo['usuario']){ ?>
stm_aix("p10i1","p1i4",[0," Solicitar Art�culos Req.","","",-1,-1,0,"/sima/OPERACIONESHOSPITALARIAS/laboratorio/solicitaReq.php","_self","","","","",5,0,0,"","",0,0,0,0,1,"#FFD2FC",0,"#CCCCCC",1,"","/sima/imagenes/fade.gif",3,3,0,0,"#7A8C9E","#CCCC00","#333333","#FFF480","7pt Verdana","7pt Verdana"],160,22);
<?php } ?>
...
stm_aix("p10i1","p6i0",[0," Men� principal","","",-1,-1,0,"/sima/OPERACIONESHOSPITALARIAS/MenuIndex.php","_self","","","","",5,0,0,"","",0,0,0,0,1,"#FFD2FC",0,"#CCCCCC",1,"","/sima/imagenes/fade.gif",3,3,0,0,"#7A8C9E","#CCCC00","#333333","#FFF480","7pt Verdana","7pt Verdana"],90,22);
