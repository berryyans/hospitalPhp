...
echo mysql_error();
if($resulScripModulo['usuario']){ ?>
stm_aix("p1i1","p0i0",[0," Pacientes Internos","","",-1,-1,0,"<?php echo CONSTANT_PATH_SIMA_RAIZ;?>/OPERACIONESHOSPITALARIAS/capellania/listapacientes.php","_self","","","","",5,0,0,"","",0,0,0,0,1,"#FFD2FC",0,"#CCCCCC",1,"","<?php echo CONSTANT_PATH_SIMA_RAIZ;?>/imagenes/fade.gif",3,3,0,0,"#7A8C9E","#CCCC00","#333333","#FFF480","7pt Verdana","7pt Verdana"],110,22);
...
echo mysql_error();
if($resulScripModulo['usuario']){ ?>
stm_aix("p1i2","p1i1",[0," Buscar Pacientes","","",-1,-1,0,"<?php echo CONSTANT_PATH_SIMA_RAIZ;?>/OPERACIONESHOSPITALARIAS/capellania/buscaPacientes.php","_self","","","","",5,0,0,"","",0,0,0,0,1,"#FFD2FC",0,"#CCCCCC",1,"","<?php echo CONSTANT_PATH_SIMA_RAIZ;?>/imagenes/fade.gif",3,3,0,0,"#7A8C9E","#CCCC00","#333333","#FFF480","7pt Verdana","7pt Verdana"],110,22);
<?php $sec='si';} else { $sec='no';} ?>
