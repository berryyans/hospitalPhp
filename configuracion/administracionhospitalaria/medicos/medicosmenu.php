...
echo mysql_error();
if($resulScripModulo['usuario']){ ?>
stm_aix("p7i19","p2i2",[0," Cat�logo de M�dicos","","",-1,-1,0,"/sima/ADMINHOSPITALARIAS/medicos/modificaMedicos1.php","_self","","","","",5,0,0,"","",0,0,0,0,1,"#FFD2FC",0,"#7a8c9e",1,"","/sima/imagenes/fade.gif",3,3,0,0,"#7A8C9E","#CCCC00","#333333","#FFF480","7pt Verdana","7pt Verdana"],160,22);
<?php } ?>
...
echo mysql_error();
if($resulScripModulo['usuario']){ ?>
stm_aix("p7i19","p2i2",[0," Cat�logo de Tipo de Medicos","","",-1,-1,0,"/sima/ADMINHOSPITALARIAS/medicos/catalogoTipoMedico.php","_self","","","","",5,0,0,"","",0,0,0,0,1,"#FFD2FC",0,"#7a8c9e",1,"","/sima/imagenes/fade.gif",3,3,0,0,"#7A8C9E","#CCCC00","#333333","#FFF480","7pt Verdana","7pt Verdana"],160,22);
<?php } ?>
...
echo mysql_error();
if($resulScripModulo['usuario']){ ?>
stm_aix("p7i19","p2i2",[0," Cat�logo de Especialidades","","",-1,-1,0,"/sima/ADMINHOSPITALARIAS/medicos/catalogoEspecialidadesMedicos.php","_self","","","","",5,0,0,"","",0,0,0,0,1,"#FFD2FC",0,"#7a8c9e",1,"","/sima/imagenes/fade.gif",3,3,0,0,"#7A8C9E","#CCCC00","#333333","#FFF480","7pt Verdana","7pt Verdana"],160,22);
<?php } ?>
...
echo mysql_error();
if($resulScripModulo['usuario']){ ?>
stm_aix("p7i9","p2i2",[0," Listado/Modifica M�dicos","","",-1,-1,0,"/sima/ADMINHOSPITALARIAS/medicos/listadoMedicos.php","_self","","","","",5,0,0,"","",0,0,0,0,1,"#FFD2FC",0,"#7a8c9e",1,"","/sima/imagenes/fade.gif",3,3,0,0,"#7A8C9E","#CCCC00","#333333","#FFF480","7pt Verdana","7pt Verdana"],138,22);
<?php } ?>
...
stm_aix("p10i1","p6i0",[0," Men� principal","","",-1,-1,0,"/sima/ADMINHOSPITALARIAS/","_self","","","","",5,0,0,"","",0,0,0,0,1,"#FFD2FC",0,"#CCCCCC",1,"","/sima/imagenes/fade.gif",3,3,0,0,"#7A8C9E","#CCCC00","#333333","#FFF480","7pt Verdana","7pt Verdana"],90,22);
